...
namespace QLPHONGKHAM
{
    public partial class DonThuoc : Form
    {
        ...
        {
            TaoDonThuocMoi();
            TaoDonThuoc taoDonThuoc = new TaoDonThuoc(role);
        ...
        private void tenBenhNhanBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void tinhTrangDiUngBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void thongTinTongQuanBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void ngayKeDonBox_ValueChanged(object sender, EventArgs e)
        {
