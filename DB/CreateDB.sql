...
(
	...
	FOREIGN KEY (BENHNHAN) REFERENCES HOSOBENHNHAN(ID)
)
GO
...
(
	...
	BENHAN CHAR(8),
	TRANGTHAI INT,
	PRIMARY KEY(BENHAN,ID),
	FOREIGN KEY (BENHAN) REFERENCES BENHAN(ID)
)
GO
...
(
	...
	NHASI char(8),
	NGAY DATE,
	PRIMARY KEY(BENHAN,KEHOACH,MADIEUTRI),
	MOTA NVARCHAR(255),
	GIA FLOAT,
	TRANGTHAI int,
	FOREIGN KEY (NHASI) REFERENCES NHASI(ID),
	FOREIGN KEY (BENHAN,KEHOACH) REFERENCES KHDIEUTRI(BENHAN,ID)
)
...
(
	...
	TIENTHOI float,
	NGAYTT DATE,
	FOREIGN KEY (BENHAN,KEHOACH,MADIEUTRI) REFERENCES DIEUTRI(BENHAN,KEHOACH,MADIEUTRI) ,
)
GO
...
INSERT INTO HOSOBENHNHAN (ID, HOTEN, NGAYSINH, DIACHI, EMAIL, SDT)
VALUES 
	('BN000001', N'Nguyễn Văn A', '1992-03-10', '321 Đường XYZ, Quận ABC','a@gmail.com', '123456789'),
	('BN000002', N'Trần Thị B', '1980-12-05', '555 Đường ABC, Quận XYZ', 'b@gmail.com', '123456780')

-- Chèn dữ liệu cho bảng BENHAN
INSERT INTO BENHAN (ID,BENHNHAN ,  THONGTINTONGQUAN)
VALUES
    ('BA000001', 'BN000001' ,'Tong quan benh ly 1'),
    ('BA000002', 'BN000002', 'Tong quan benh ly 2');
-- Chèn dữ liệu cho bảng KHDIEUTRI
INSERT INTO KHDIEUTRI(ID, BENHAN, TRANGTHAI) 
VALUES
	('KH000001','BA000001', 1),
	('KH000002', 'BA000001', 0),
	('KH000001', 'BA000002', 0);
...
INSERT INTO DIEUTRI (MADIEUTRI, BENHAN, KEHOACH, NHASI, NGAY,  MOTA, GIA, TRANGTHAI)
VALUES
(1, 'BA000001', 'KH000001', 'NS000001', '2023-01-01', 'Treatment for BN000001', 1500000, 1),
(2, 'BA000001', 'KH000002', 'NS000002', '2023-02-01',  'Treatment for BN000002', 500000, 1),
(1, 'BA000002', 'KH000001', 'NS000001', '2023-02-01',  'Treatment for BN000002', 500000, 1);

INSERT INTO THANHTOAN (MADIEUTRI, BENHAN, KEHOACH, LATIENMAT, TIENNHAN, TIENTHOI, NGAYTT)
VALUES
(1, 'BA000001', 'KH000001', 0x01, 100.0, 50.0, '2023-01-15'),
(2, 'BA000001', 'KH000002', 0x00, 200.0, 0.0, '2023-02-20'),
(1, 'BA000002', 'KH000001', 0x00, 200.0, 0.0, '2023-02-20');

-- Chèn dữ liệu cho bảng TAIKHAM
INSERT INTO CUOCHEN(BENHNHAN, NHASI,NGAYHEN, GIOHEN, GHICHU, TRANGTHAI, PHONG)
VALUES
    ( 'BN000001', 'NS000001', '2023-01-15' ,'08:30:00','ghi chu', 1, 1),
	( 'BN000001', 'NS000001', '2023-02-18' ,'14:00:00','ghi chu', 0, 2),
    ( 'BN000002', 'NS000001', '2023-02-18' ,'14:00:00','ghi chu', 0, 3);
